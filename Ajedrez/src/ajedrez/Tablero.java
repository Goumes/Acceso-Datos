...
/* Propiedades.
 * 		B�sicas:		Pieza [][] tablero			----------			Consultable / Modificable
 * 		Derivadas:
 * 		Compartidas:
 * 
 * Restricciones: El tablero debe ser siempre de 8 x 8
 * 
 * Criterio de comparaci�n: Tama�o del array tablero.
 * Criterio de igualdad: Tama�o del array tablero.
 * 
 * Metodos a�adidos: generarTablero, mostrarTablero, moverPieza
 * 
 */
...
public class Tablero implements Cloneable, Comparable <Tablero>
{
	 ...
	 * Breve comentario: Mueve una pieza de una posici�n a otra.
	 * Precondiciones: La primera fila y columna son la posici�n original.
