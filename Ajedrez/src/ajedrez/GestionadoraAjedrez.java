...
{	
		...
		{	
			...
			{ 
 				do
 				{
 					...
 					{
 						System.out.println("Selecciona una columna v�lida.");
 					}
 				}
 				...
 				do
 				{
 					...
 					{
 						System.out.println("Selecciona una fila v�lida.");
 					}
 				}
 				...
 				{
 					Continuar = false;
 					System.out.println("No puedes seleccionar una casilla vac�a.");
 				}
			}
	 ...
	 * Resguardo: public static boolean comprobarVictoria (Tablero tablero)
		{
			...
			System.out.println("Llamada al m�todo comprobarVictoria");
	 ...
	 * Breve comentario: Transforma un caracter a un entero relacionado con la posici�n en el tablero.
	 * Precondiciones: Un caracter de la a a la h.
	 * Entradas: Un caracter
	 * Salidas: Un entero
	 * Entradas/Salidas: Ninguna
	 * Postcondiciones: Un entero en relaci�n al caracter recibido.
	 * 
	 ...
	 * Breve comentario: Transforma un entero a otro relacionado con la posici�n en el tablero.
	 * Precondiciones: Un entero del 1 al 8
	 * Entradas: Un entero
	 * Salidas: Un entero
	 * Entradas/Salidas: Ninguna
	 * Postcondiciones: Un entero nuevo en relaci�n al entero recibido.
	 * 
	 ...
	 * Salidas: Un String
	 * Entradas/Salidas: Ninguna
	 * Postcondiciones: La cadena devuelve "0" si se ha movido correctamente, -1 sino o un conjunto de dos numeros separados por "," para indicar la nueva posici�n si se ha encontrado con un obstaculo.
	 * 
	 ...
	 * Breve comentario: Comprueba si el rey est� en jaque.
	 * Precondiciones: Una partida con el rey en juego.
	 * Entradas: Un tablero y un booleano
	 * Salidas: Un entero
	 * Entradas/Salidas: Ninguna
	 * Postcondiciones: 0 si el rey no est� en jaque, 1 si el rey est� en jaque, 2 si es jaque mate.
	 * 
